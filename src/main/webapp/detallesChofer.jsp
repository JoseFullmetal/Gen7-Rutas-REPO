            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <stong>Ap. Paterno:</stong>
                            <%=chofer.getApPaterno()%>
                        </li>
                        <li class="list-group-item">
                            <stong>Ap. Materno</stong>
                            <%=chofer.getApMaterno()%>
                        </li>
                        <li class="list-group-item">
                            <stong>Licencia: </stong>
                            <%=chofer.getLicencia()%>
                        </li>
                        <li class="list-group-item">
                            <stong>Telefono: </stong>
                            <%=chofer.getTelefono()%>
                        </li>
                        <li class="list-group-item">
                            <stong>Fecha Nacimienot: </stong>
                            <%=fecha%>
                        </li>
                        <li class="list-group-item">
                            <stong>Disponibilidad: </stong>
                            <%=disponible%>
                        </li>
                    </ul>
                </div>
