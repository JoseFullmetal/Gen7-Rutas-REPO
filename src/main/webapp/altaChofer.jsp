            ...
            <form action="<%= request.getContextPath() %>/choferes/alta" method="post">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" value="<%= request.getParameter("nombre") != null ? request.getParameter("nombre") : "" %>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apPaterno" id="apPaterno" class="form-control" value="<%= request.getParameter("apPaterno") != null ? request.getParameter("apPaterno") : "" %>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apMaterno" id="apMaterno" class="form-control" value="<%= request.getParameter("apMaterno") != null ? request.getParameter("apMaterno") : "" %>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="licencia" id="licencia" class="form-control" value="<%= request.getParameter("licencia") != null ? request.getParameter("licencia") : "" %>">
                        <% if (errores != null && errores.containsKey("licencia")) { %>
                            <span class='text-danger'><%= errores.get("licencia") %></span>
                        <% } %>
                    </div>

                    <div class="form-group">
                        <label for="telefono">Telefono</label>
                        <input type="text" name="telefono" id="telefono" class="form-control" value="<%= request.getParameter("telefono") != null ? request.getParameter("telefono") : "" %>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fechaNacimiento" id="fechaNacimiento" class="form-control" value="<%= request.getParameter("fechaNacimiento") != null ? request.getParameter("fechaNacimiento") : "" %>">
                        <% if (errores != null && errores.containsKey("fechaNacimiento")) { %>
                            <span class='text-danger'><%= errores.get("fechaNacimiento") %></span>
                        <% } %>
                    </div>
