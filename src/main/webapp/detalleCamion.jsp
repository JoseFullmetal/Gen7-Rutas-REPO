...
String disponibilidad = camion.getDisponibilidad() ? "Disponible" : "No disponible";
%>
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <%=camion.getCapacidad()%> toneladas
                        </li>
                        <li class="list-group-item">
                            <strong>Kilometraje:</strong>
                            <%=camion.getKilometraje()%> km
                        </li>
                        <li class="list-group-item">
